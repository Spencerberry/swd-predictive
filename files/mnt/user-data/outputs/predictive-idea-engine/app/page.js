      ...
      <main className="min-h-screen pt-16 flex items-center justify-center px-6">
        <div className="max-w-3xl w-full text-center">
          ...
          {!loading && !user ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.15s', animationFillMode: 'backwards' }}>
              <Link href="/ideas" className="group">
                <div className="rounded-2xl bg-surface-secondary border border-surface-border p-8 text-left transition-all duration-300 hover:border-brand-green/40 hover:bg-surface-tertiary">
                  ...
                  <h2 className="text-xl font-bold text-white mb-2">Idea Engine</h2>
                  <p className="text-neutral-400 text-sm leading-relaxed">
                    Enter your channel. Get video ideas based on what&apos;s already working for your audience.
                  </p>
